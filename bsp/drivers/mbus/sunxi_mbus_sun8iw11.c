...
struct port_index {
	...
	MBUS_PORT_CPU, MBUS_PORT_GPU,    MBUS_PORT_DMA,
	MBUS_PORT_VE,  MBUS_PORT_CSI,	MBUS_PORT_NAND,
	MBUS_PORT_SS,  MBUS_PORT_TS,     MBUS_PORT_DI,
	MBUS_PORT_DE,  MBUS_PORT_DE_CFD, MBUS_PORTS_MAX,
};
