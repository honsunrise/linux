...
struct port_index {
	...
	MBUS_PORT_CPU,   MBUS_PORT_MAHB,
	MBUS_PORT_DMA,   MBUS_PORT_CE,
	MBUS_PORT_NDFC0, MBUS_PORT_AXI,
	MBUS_PORTS_MAX,
};
...
MBUS_SENSOR_DEVICE_ATTR_RO(pmu_disp_ddr,     MBUS_PMU_DISP);
...
static struct attribute *mbus_attributes[] = {
	...
	SENSOR_DEVICE_ATTR_PTR(pmu_disp_ddr),
...
MODULE_DESCRIPTION("SUNXI SUN8IW18 MBUS Driver");
