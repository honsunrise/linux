...
struct port_index {
	...
	MBUS_PORT_VE,    MBUS_PORT_CE,    MBUS_PORT_TVD,
	MBUS_PORT_CSI,   MBUS_PORT_G2D,   MBUS_PORT_DI,
	MBUS_PORT_DE,    MBUS_PORT_IOMMU, MBUS_PORT_DSP,
	MBUS_PORT_RISCV, MBUS_PORTS_MAX,
};
...
MODULE_DESCRIPTION("SUNXI SUN8IW20 MBUS Driver");
