...
#define DEV_DBG_EN   0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[CSI_DEBUG][GC2145]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif

#define vfe_dev_err(x, arg...) pr_err("[CSI_ERR][GC2145]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[CSI][GC2145]"x, ##arg)
...
#define CLK_POL           V4L2_MBUS_PCLK_SAMPLE_FALLING /* RISING */
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
	...
	return sensor_write_array(sd, sensor_default_regs,
