...
/*
 * A V4L2 driver for OV2775 Raw cameras.
 *
 */
...
MODULE_AUTHOR("pcw");
MODULE_DESCRIPTION("A low-level driver for OV2775 Raw sensors");
MODULE_LICENSE("GPL");

/* for internal driver debug */
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define vfe_dev_dbg(x, arg...) pr_debug("[OV2775 Raw]"x, ##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...) pr_err("[OV2775 Raw]"x, ##arg)
#define vfe_dev_print(x, arg...) pr_info("[OV2775 Raw]"x, ##arg)
...
static int sensor_detect(struct v4l2_subdev *sd)
{
	...
	vfe_dev_dbg("***sensor ov2775,read 0x300A is 0x%x***\n", rdval);

	LOG_ERR_RET(sensor_read(sd, 0x300B, &rdval));
	vfe_dev_dbg("***sensor ov2775,read 0x300B is 0x%x***\n", rdval);

	vfe_dev_dbg("***find ov2775 raw data camera sensor***\n");
